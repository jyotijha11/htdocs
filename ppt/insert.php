				...
				<div class = "md-4 text-center">
					...
					<form method="post" action=" ">
						...
						<div class="col-sm-6 mb-4">
							...
							<input type="text" class="container" required name="name" placeholder="Name">
						</div>
						<div class="col-sm-6 mb-4">
							<label>Phone</label>
							<input type="text" class="container" required name="phone" placeholder="Phone">
						</div>
						<div class="col-sm-6 mb-4">
							<label>Email</label>
							<input type="email" class="container" required name="email" placeholder="Email">
						</div>
						<div class="col-sm-6 mb-4">
							<label>Password</label>
						    <input type="password" class="container" required name="password" placeholder="Password">
						</div>
