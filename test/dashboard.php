...
<?php
                        ...
                        $sql = "SELECT * FROM schedule where id=".$_SESSION['id'];
                          ...
                          <?php if(!empty($arr_users)) { ?>
                              <?php foreach($arr_users as $users) { ?>
                                  <tr>
                                      ...
                                      <td><a class="btn btn-sm btn-success" href="update.php?id=<?php echo $users["id"];?>"> <i class="fa fa-edit"></i>Update </a></td>
                                  </tr>
                              <?php } ?>
                          <?php } ?>
                      </tbody>
