...
<div class="col-sm-5">
<div class="login-box">
<div class="mb-4 text-center"> <h2> Employee Login  </h2> </div>
  <form action=" " method="post">
    ...
    <button type="submit" name="submit" class="btn btn-success btn-block"></a> <i class="fa fa-sign-in"></i> Login </button>
  </form>
