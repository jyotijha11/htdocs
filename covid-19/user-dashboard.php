  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <?php
                 $location_id = $_POST['location_id'];
                  $date = $_POST['date'];
                  $sql = "select * from location where id = '$location_id' AND date = '$date'";
                    ...
                    <?php if(!empty($arr_users)) { ?>
                        <?php foreach($arr_users as $users) { ?>
                            <tr>
                              ...
                              <td><?php echo $users['slot']; ?></td>            
                              <td>
                                 <a href="booking.php?loction_id=<?php echo $users['id']; ?>&date=<?php echo $users['date']; ?>">Book Now</a>
                              </td>   
                            </tr>
                        <?php } ?>
                    <?php } ?>
