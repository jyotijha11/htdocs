 ...
 $conn = mysqli_connect("localhost", "root", "", "cars");
	...
	if(isset($_POST['save']))
	{
	    ...
	    $sql = "INSERT INTO product(name,cat,price,sprice,color,feed,image,des,pay) VALUES('$cname','$ccat','$cprice','$csprice','$ccolor','$chigh','$cimg','$cdes','$pay')";
...
<head>
	...
	body
	{
		background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCf0CccBS6bVJ7h7sk2uSCqIvmfWWSmtqSvQ&usqp=CAU');
